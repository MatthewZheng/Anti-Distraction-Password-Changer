!define PRODUCT_NAME "LifeScript"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.6.0"
!define PY_MAJOR_VERSION "3.6"
!define BITNESS "64"
!define ARCH_TAG ".amd64"
!define INSTALLER_NAME "LifeScript_1.0.exe"
!define PRODUCT_ICON "newicon-alt.gif"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "$INSTDIR"
      ...
      ; Install files
    SetOutPath "$INSTDIR"
      File "LifeScript.launch.pyw"
      File "newicon-alt.gif"
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\LifeScript.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\LifeScript.launch.pyw"' "$INSTDIR\newicon-alt.gif"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\LifeScript.launch.pyw"
    Delete "$INSTDIR\newicon-alt.gif"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\LifeScript.lnk"
  RMDir $INSTDIR
